...
g_l = [];
g_l["MONTHS"] = ["იანვარი","თებერვალი","მარტი","აპრილი","მაისი","ივნისი","ივლისი","აგვისტო","სექტემბერი","ოქტომბერი","ნოემბერი","დეკემბერი"];
g_l["DAYS_3"] = ["კვი","ორშ","სამ","ოთხ","ხუთ","პარ","შაბ"];
g_l["MONTH_FWD"] = "თვის მომატება";
g_l["MONTH_BCK"] = "თვის მოკლება";
g_l["YEAR_FWD"] = "წლის მომატება";
g_l["YEAR_BCK"] = "წლის მოკლება";
g_l["CLOSE"] = "კალენდრის დახურვა";
g_l["ERROR_2"] = g_l["ERROR_1"] = "თარიღი არასწორია!";
g_l["ERROR_4"] = g_l["ERROR_3"] = "ობიექტი არასწორია!";
...
JsDatePick.prototype.setConfiguration = function(aConf){
	...
	this.oConfiguration.imgPath			= (aConf["imgPath"] != null) ? aConf["imgPath"] : g_jsDatePickImagePath;
