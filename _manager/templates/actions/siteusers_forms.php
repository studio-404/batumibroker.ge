...
<?php $ulink = ($action=="add") ? ahref('siteusers', 'add') : ahref('siteusers', 'edit', array('id'=>$user["id"])); ?>
                <form id="catform" method="post" action="<?php echo $ulink;?>">
					...
					<div class="list fix">
						<div class="name">Skype Name: <span class="star">*</span></div>					
						<input type="text" name="skype" id="skype" value="<?php echo ($action=="edit") ? $user["skype"] : '' ;?>" class="inp-small"/>
						<div class="name"><?php echo a("address");?>: <span class="star">*</span></div>					
						<input type="text" name="address" id="address" value="<?php echo ($action=="edit") ? $user["address"] : '' ;?>" class="inp-small"/>
					</div>	
