<?php defined('DIR') OR exit; ?>
		...
		<div id="box">
			<div id="part">
				...
				<div id="user">
					<div class="list-top">
						<div class="check" style="width:100px;"><?php echo a("active");?></div>
						<div class="check" style="width:100px;"><?php echo a("banned");?></div>
						<div class="name" style="width:70px;">ID</div>
...
?>
					<div id="user" class="<?php echo $class;?> fix">
						<div class="check" style="width:100px;">
