...
<div id="footer">
	<div id="part">
    	<br />
    	<br />
		<img src="<?php echo CMS; ?>/img/login-logo.png" width="147" height="21" alt="" />
    	<br />
...
<?php } ?>        
			...
			<form action="<?php echo ahref('access', 'login') ?>" method="post" name="loginform" id="loginform" style="width:300px; padding-left:170px;">
			...
			<span id="copyright">Copyright &copy; 2011 <a href="http://shindi.ge" target="_blank">ShinDi</a>. All rights reserved.</span>
        </div>
	</div>
</div>
